...
class GruRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, output_size, batch_size=1, layers=1, bi=False, cuda=True):
        """
...
class Engadget():
    ...
    def __init__(self, model, char2vec=None, output_char2vec=None, cuda=True):
